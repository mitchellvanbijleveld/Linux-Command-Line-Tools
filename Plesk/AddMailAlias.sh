...
VAR_SCRIPT_REQUIRED_COMMAND_LINE_TOOLS="echo plesk PrintMessage"
...
PrintMessage "INFO" "$VAR_UTILITY" "$VAR_UTILITY_SCRIPT" "New email address / alias: '$VAR_EMAIL_ADDRESS_NEW_WITH_ALIAS'."
